    ...
    <!-- Content begin-->
	   <div class="column-fluid">
	    	<div class="content">
	    		<!-- CurrentPage begin -->
	    		<div class="cur-title">
	    			<b><a href="<?php $category= get_the_category();echo get_category_link($category[0]->term_id ) ?>"><?php  echo$category[0]->cat_name; ?></a></b>
	    		...
	    		<ul class="postlist">
	    		<?php
                query_posts($query_string.'&cat='.$category[0]->term_id);
	    		if (have_posts()) : 
